      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-card">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Botao onClick={() => setModalCursoAberto(true)}>Novo curso</Botao>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-card">
        ...
        {cursos.length === 0 ? (
          <EstadoVazio
            ...
            aoAcionar={() => setModalCursoAberto(true)}
            icone={
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/50 px-4 py-6 backdrop-blur-sm">
          <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5">
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-primario">Novo curso</p>
                <h3 className="mt-1 text-xl font-bold text-slate-950">Criar curso</h3>
                <p className="mt-1 text-sm text-slate-500">Defina o catálogo. A apostila é montada na seção de conteúdo.</p>
              </div>
              <button
            ...
            <form className="grid gap-4 px-6 py-5" onSubmit={criar}>
              ...
              <div className="flex flex-col-reverse gap-2 border-t border-slate-100 pt-4 sm:flex-row sm:justify-end">
                <Botao type="button" variante="fantasma" onClick={() => setModalCursoAberto(false)}>
                  Cancelar
                </Botao>
