...
const ITENS_PROFISSIONAL: ItemNav[] = [
  ...
  { rotulo: 'Serviços', para: '/painel/servicos', icone: <Ic d="M9 6h6m-6 4h6m-6 4h3m-7 6h14a2 2 0 002-2V6.5L16.5 2H5a2 2 0 00-2 2v14a2 2 0 002 2z" /> },
  ...
  { rotulo: 'Agendamentos', para: '/painel/agendamentos', icone: <Ic d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /> },
